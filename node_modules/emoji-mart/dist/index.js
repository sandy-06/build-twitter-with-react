...
function $bae69aa06de56369$var$latestVersion() {
    for (const { v: v , emoji: emoji  } of $bae69aa06de56369$var$VERSIONS){
        if ($bae69aa06de56369$var$testEmoji(emoji)) return v;
    }
}
function $bae69aa06de56369$var$noCountryFlags() {
    if ($bae69aa06de56369$var$testEmoji('🇨🇦')) return false;
    return true;
}
function $bae69aa06de56369$var$testEmoji(emoji) {
    ...
    for (const category of $205291deb9107ba0$export$2d0294657ab35f1b.categories){
        ...
        while(i--){
            ...
            if (noCountryFlags && category.id == 'flags') {
                if (!$793465abcb382f5b$export$bcb25aa587e9cb13.includes(emoji.id)) ignore = true;
            }
            if (ignore) {
...
function $39dd3be3baae5f42$export$2e2bcd8739ae039(props) {
    ...
    const src = emojiSkin.src || (props.set != 'native' && !props.spritesheet ? `https://cdn.jsdelivr.net/npm/emoji-datasource-${props.set}@14.0.0/img/${props.set}/64/${emojiSkin.unified}.png` : undefined);
    return(/*#__PURE__*/ $6c8933bfb6137ffb$export$34b9dba7ce09269b("span", {
        class: "emoji-mart-emoji",
        "data-emoji-set": props.set,
        children: src ? /*#__PURE__*/ $6c8933bfb6137ffb$export$34b9dba7ce09269b("img", {
            style: {
    ...
    render() {
        return(/*#__PURE__*/ $6c8933bfb6137ffb$export$34b9dba7ce09269b("section", {
            ...
            children: [
                ...
                this.props.stickySearch && /*#__PURE__*/ $6c8933bfb6137ffb$export$34b9dba7ce09269b("div", {
                    class: "padding-lr",
